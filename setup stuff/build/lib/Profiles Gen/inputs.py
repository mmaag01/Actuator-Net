...
def vel_tor_profile(times, n_vel=20, t_ramp=1.5):
    ...
    #tor_max_func = interp1d(vel_boundary, tor_boundary, kind='cubic')
    tor_max_func = lambda v: np.interp(v, vel_boundary, tor_boundary)
    tor_max_func = interp1d(vel_boundary, tor_boundary, kind='cubic', fill_value='extrapolate')
    ...
    tor_max_ref = tor_max_func(vel_ref)
